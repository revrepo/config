...
#
# UFW configuration script for PORATL servers
#
...
# Allow CUBE ports 1080 and 1081 from the monitoring servers
# Allow from SJC02-MONITOR02
ufw allow proto tcp from 54.193.118.76/32 to any port 1080:1081
# Allow from IAD02-MONITOR01
ufw allow proto tcp from 54.88.56.156/32 to any port 1080:1081
...
# Allow HTTP, HTTPS and 3000/TCP from anywhere
ufw allow 80/tcp
ufw allow 443/tcp
ufw allow 3000/tcp
