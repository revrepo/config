...
ufw allow proto tcp from 54.88.69.242/32 to any port 7443
# Allow from IAD02-API01
ufw allow proto tcp from 54.165.134.123/32 to any port 7443
# Allow from IAD02-API03
ufw allow proto tcp from 54.165.8.28/32 to any port 7443
# Allow from IAD02-STATSAPI01
ufw allow proto tcp from 52.1.122.69/32 to any port 7443
