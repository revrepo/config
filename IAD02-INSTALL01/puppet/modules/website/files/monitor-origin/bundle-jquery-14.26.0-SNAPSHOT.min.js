...
/*
	Plugin Download url : http://jquery.thewikies.com/swfobject/
*/
(function(d){var b=document,e="object",c=window,a="";d.flashPlayerVersion=(function(){var j,l,g,h,m=false,f="ShockwaveFlash.ShockwaveFlash";if(!(j=navigator.plugins["Shockwave Flash"])){try{l=new ActiveXObject(f+".7");}catch(g){try{l=new ActiveXObject(f+".6");j=[6,0,21];l.AllowScriptAccess="always";}catch(h){if(j&&j[0]===6){m=true;}}if(!m){try{l=new ActiveXObject(f);}catch(i){j="X 0,0,0";}}}if(!m&&l){try{j=l.GetVariable("$version");}catch(k){}}}else{j=j.description;}j=j.match(/^[A-Za-z\s]*?(\d+)(\.|,)(\d+)(\s+r|,)(\d+)/);return[j[1]*1,j[3]*1,j[5]*1];}());d.flashExpressInstaller="expressInstall.swf";d.hasFlashPlayer=(d.flashPlayerVersion[0]!==0);d.hasFlashPlayerVersion=function(f){var g=d.flashPlayerVersion;f=(/string|number/.test(typeof f))?f.toString().split("."):f;f=[f.major||f[0]||g[0],f.minor||f[1]||g[1],f.release||f[2]||g[2]];return(d.hasFlashPlayer&&(f[0]>g[0]||(f[0]===g[0]&&(f[1]>g[1]||(f[1]===g[1]&&f[2]>=g[2])))));};d.flash=function(f){if(!d.hasFlashPlayer){return false;}var q=f.swf||a,h=f.params||{},o=b.createElement("body"),r,g,k,p,i,j,l,m;f.height=f.height||180;f.width=f.width||320;if(f.hasVersion&&!d.hasFlashPlayerVersion(f.hasVersion)){d.extend(f,{id:"SWFObjectExprInst",height:Math.max(f.height,137),width:Math.max(f.width,214)});q=f.expressInstaller||d.flashExpressInstaller;h={flashvars:{MMredirectURL:location.href,MMplayerType:(d.browser.msie&&d.browser.win)?"ActiveX":"PlugIn",MMdoctitle:b.title.slice(0,47)+" - Flash Player Installation"}};}if(typeof h===e){if(f.flashvars){h.flashvars=f.flashvars;}if(f.wmode){h.wmode=f.wmode;}}for(i in (j=["expressInstall","flashvars","hasVersion","params","swf","wmode"])){delete f[j[i]];}r=[];for(i in f){if(typeof f[i]===e){g=[];for(j in f[i]){g.push(j.replace(/([A-Z])/,"-$1").toLowerCase()+":"+f[i][j]+";");}f[i]=g.join(a);}r.push(i+'="'+f[i]+'"');}f=r.join(" ");if(typeof h===e){r=[];for(i in h){if(typeof h[i]===e){g=[];for(j in h[i]){if(typeof h[i][j]===e){k=[];for(l in h[i][j]){if(typeof h[i][j][l]===e){p=[];for(m in h[i][j][l]){p.push([m.replace(/([A-Z])/,"-$1").toLowerCase(),":",h[i][j][l][m],";"].join(a));}h[i][j][l]=p.join(a);}k.push([l,"{",h[i][j][l],"}"].join(a));}h[i][j]=k.join(a);}g.push([j,"=",c.escape(h[i][j])].join(a));}h[i]=g.join("&amp;");}r.push(['<PARAM NAME="',i,'" VALUE="',h[i],'">'].join(a));}h=r.join(a);}if(!(/style=/.test(f))){f+=' style="vertical-align:text-top;"';}if(!(/style=(.*?)vertical-align/.test(f))){f=f.replace(/style="/,'style="vertical-align:text-top;');}if(d.browser.msie){f+=' classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"';h='<PARAM NAME="movie" VALUE="'+q+'">'+h;}else{f+=' type="application/x-shockwave-flash" data="'+q+'"';}o.innerHTML=["<OBJECT ",f,">",h,"</OBJECT>"].join(a);return d(o.firstChild);};d.fn.flash=function(g){if(!d.hasFlashPlayer){return this;}var h=0,f;while((f=this.eq(h++))[0]){f.html(d.flash(d.extend({},g)));if(b.getElementById("SWFObjectExprInst")){h=this.length;}}return this;};}(jQuery));
/*
 ...
 *
 **/
(function(){var c;var b;c=jQuery.fn.flash=function(h,g,e,j){var i=e||c.replace;g=c.copy(c.pluginOptions,g);if(!c.hasFlash(g.version)){if(g.expressInstall&&c.hasFlash(6,0,65)){var f={flashvars:{MMredirectURL:location,MMplayerType:"PlugIn",MMdoctitle:jQuery("title").text()}};}else{if(g.update){i=j||c.update;}else{return this;}}}h=c.copy(c.htmlOptions,f,h);return this.each(function(){i.call(this,c.copy(h));});};c.copy=function(){var g={},f={};for(var h=0;h<arguments.length;h++){var e=arguments[h];if(e==undefined){continue;}jQuery.extend(g,e);if(e.flashvars==undefined){continue;}jQuery.extend(f,e.flashvars);}g.flashvars=f;return g;};c.hasFlash=function(){if(/hasFlash\=true/.test(location)){return true;}if(/hasFlash\=false/.test(location)){return false;}var f=c.hasFlash.playerVersion().match(/\d+/g);var g=String([arguments[0],arguments[1],arguments[2]]).match(/\d+/g)||String(c.pluginOptions.version).match(/\d+/g);for(var e=0;e<3;e++){f[e]=parseInt(f[e]||0);g[e]=parseInt(g[e]||0);if(f[e]<g[e]){return false;}if(f[e]>g[e]){return true;}}return true;};c.hasFlash.playerVersion=function(){try{try{var f=new ActiveXObject("ShockwaveFlash.ShockwaveFlash.6");try{f.AllowScriptAccess="always";}catch(g){return"6,0,0";}}catch(g){}return new ActiveXObject("ShockwaveFlash.ShockwaveFlash").GetVariable("$version").replace(/\D+/g,",").match(/^,?(.+),?$/)[1];}catch(g){try{if(navigator.mimeTypes["application/x-shockwave-flash"].enabledPlugin){return(navigator.plugins["Shockwave Flash 2.0"]||navigator.plugins["Shockwave Flash"]).description.replace(/\D+/g,",").match(/^,?(.+),?$/)[1];}}catch(g){}}return"0,0,0";};c.htmlOptions={height:240,flashvars:{},pluginspage:"http://www.adobe.com/go/getflashplayer",src:"#",type:"application/x-shockwave-flash",width:320};c.pluginOptions={expressInstall:false,update:true,version:"6.0.65"};c.replace=function(e){this.innerHTML='<div class="alt">'+this.innerHTML+"</div>";jQuery(this).addClass("flash-replaced");this.innerHTML=c.transform(e);};c.update=function(f){var e=String(location).split("?");e.splice(1,0,"?hasFlash=true&");e=e.join("");var g='<p>This content requires the Flash Player. <a href="http://www.adobe.com/go/getflashplayer">Download Flash Player</a>. Already have Flash Player? <a href="'+e+'">Click here.</a></p>';this.innerHTML='<span class="alt">'+this.innerHTML+"</span>";jQuery(this).addClass("flash-update").prepend(g);};function a(){var f="";for(var e in this){if(typeof this[e]!="function"){f+=e+'="'+this[e]+'" ';}}return f;}function d(){var f="";for(var e in this){if(typeof this[e]!="function"){f+=e+"="+encodeURIComponent(this[e])+"&";}}b=f.replace(/&$/,"");return b;}c.transform=function(f){f.toString=a;if(f.flashvars){f.flashvars.toString=d;}if($.browser.msie){var e="<object classid='clsid:d27cdb6e-ae6d-11cf-96b8-444553540000' codebase='https://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0'	width='"+f.width+"' height='"+f.height+"' id='"+f.id+"' name='"+f.name+"' align='right'><param name='allowScriptAccess' value='always' /><param name='allowFullScreen' value='false' /><param name='movie' value='"+f.src+"' /><param name='loop' value='false' /><param name='quality' value='high' /><param name='FlashVars' value='"+f.flashvars+"'/><param name='bgcolor' value='#ffffff' /><param name='wmode' value='opaque' /></object>";return e;}return"<embed "+String(f)+"/>";};if(window.attachEvent){window.attachEvent("onbeforeunload",function(){__flash_unloadHandler=function(){};__flash_savedUnloadHandler=function(){};});}})();
 ...
 *
 **/
new function(e){var d=e.separator||"&";var c=e.spaces===false?false:true;var a=e.suffix===false?"":"[]";var g=e.prefix===false?false:true;var b=g?e.hash===true?"#":"?":"";var f=e.numbers===false?false:true;jQuery.query=new function(){var h=function(m,l){return m!=undefined&&m!==null&&(!!l?m.constructor==l:true);};var i=function(s){var l,r=/\[([^[]*)\]/g,o=/^([^[]+)(\[.*\])?$/.exec(s),p=o[1],q=[];while(l=r.exec(o[2])){q.push(l[1]);}return[p,q];};var k=function(u,s,r){var v,q=s.shift();if(typeof u!="object"){u=null;}if(q===""){if(!u){u=[];}if(h(u,Array)){u.push(s.length==0?r:k(null,s.slice(0),r));}else{if(h(u,Object)){var p=0;while(u[p++]!=null){}u[--p]=s.length==0?r:k(u[p],s.slice(0),r);}else{u=[];u.push(s.length==0?r:k(null,s.slice(0),r));}}}else{if(q&&q.match(/^\s*[0-9]+\s*$/)){var m=parseInt(q,10);if(!u){u=[];}u[m]=s.length==0?r:k(u[m],s.slice(0),r);}else{if(q){var m=q.replace(/^\s*|\s*$/g,"");if(!u){u={};}if(h(u,Array)){var l={};for(var p=0;p<u.length;++p){l[p]=u[p];}u=l;}u[m]=s.length==0?r:k(u[m],s.slice(0),r);}else{return r;}}}return u;};var j=function(l){var m=this;m.keys={};if(l.queryObject){jQuery.each(l.get(),function(o,p){m.SET(o,p);});}else{jQuery.each(arguments,function(){var o=""+this;o=o.replace(/^[?#]/,"");o=o.replace(/[;&]$/,"");if(c){o=o.replace(/[+]/g," ");}jQuery.each(o.split(/[&;]/),function(){var p=decodeURIComponent(this.split("=")[0]||"");var q=decodeURIComponent(this.split("=")[1]||"");if(!p){return;}if(f){if(/^[+-]?[0-9]+\.[0-9]*$/.test(q)){q=parseFloat(q);}else{if(/^[+-]?[0-9]+$/.test(q)){q=parseInt(q,10);}}}q=(!q&&q!==0)?true:q;if(q!==false&&q!==true&&typeof q!="number"){q=q;}m.SET(p,q);});});}return m;};j.prototype={queryObject:true,has:function(l,m){var o=this.get(l);return h(o,m);},GET:function(m){if(!h(m)){return this.keys;}var l=i(m),o=l[0],q=l[1];var p=this.keys[o];while(p!=null&&q.length!=0){p=p[q.shift()];}return typeof p=="number"?p:p||"";},get:function(l){var m=this.GET(l);if(h(m,Object)){return jQuery.extend(true,{},m);}else{if(h(m,Array)){return m.slice(0);}}return m;},SET:function(m,s){var p=!h(s)?null:s;var l=i(m),o=l[0],r=l[1];var q=this.keys[o];this.keys[o]=k(q,r.slice(0),p);return this;},set:function(l,m){return this.copy().SET(l,m);},REMOVE:function(l){return this.SET(l,null).COMPACT();},remove:function(l){return this.copy().REMOVE(l);},EMPTY:function(){var l=this;jQuery.each(l.keys,function(m,o){delete l.keys[m];});return l;},load:function(l){var o=l.replace(/^.*?[#](.+?)(?:\?.+)?$/,"$1");var m=l.replace(/^.*?[?](.+?)(?:#.+)?$/,"$1");return new j(l.length==m.length?"":m,l.length==o.length?"":o);},empty:function(){return this.copy().EMPTY();},copy:function(){return new j(this);},COMPACT:function(){function l(p){var o=typeof p=="object"?h(p,Array)?[]:{}:p;if(typeof p=="object"){function m(s,q,r){if(h(s,Array)){s.push(r);}else{s[q]=r;}}jQuery.each(p,function(q,r){if(!h(r)){return true;}m(o,q,l(r));});}return o;}this.keys=l(this.keys);return this;},compact:function(){return this.copy().COMPACT();},toString:function(){var o=0,s=[],r=[],m=this;var p=function(u){u=u+"";if(c){u=u.replace(/ /g,"+");}return encodeURIComponent(u);};var l=function(u,v,w){if(!h(w)||w===false){return;}var x=[p(v)];if(w!==true){x.push("=");x.push(p(w));}u.push(x.join(""));};var q=function(v,u){var w=function(x){return !u||u==""?[x].join(""):[u,"[",x,"]"].join("");};jQuery.each(v,function(x,y){if(typeof y=="object"){q(y,w(x));}else{l(r,w(x),y);}});};q(this.keys);if(r.length>0){s.push(b);}s.push(r.join(d));return s.join("");}};return new j(location.search,location.hash);};}(jQuery.query||{});