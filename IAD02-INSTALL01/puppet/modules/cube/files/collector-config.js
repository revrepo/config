...
module.exports = {
  "mongo-host": ["IAD02-RMDB01.REVSW.NET"],
  "mongo-port": [27017],
  "is_replica_set": true,
  "replica_set_name":"RMDB-rs0",
  "aditional_params":"slaveOK=true&readPreference=secondaryPreferred&connectWithNoPrimary=true",
//   "full_connection_string":"mongodb://54.173.88.238:27017/cube_development?replicaSet=rs0&slaveOK=true&readPreference=secondaryPreferred&connectWithNoPrimary=true",
